...
METRIC_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "MET-SOM": {"description": "수익 가능 시장 규모 (Serviceable Obtainable Market)", "unit": "currency", "aggregation": "latest", "distribution_type": "lognormal"},
    "MET-Churn_rate": {"description": "고객 이탈률", "unit": "ratio", "aggregation": "weighted_average", "bounds": {'min': 0.0, 'max': 1.0}, "distribution_type": "beta"},
    "MET-Gross_margin": {"description": "매출 총이익률", "unit": "ratio", "aggregation": "weighted_average", "bounds": {'min': 0.0, 'max': 1.0}, "distribution_type": "beta"},
    "MET-LTV": {"description": "고객 생애 가치 (Lifetime Value)", "unit": "currency", "aggregation": "weighted_average", "distribution_type": "lognormal"},
    "MET-CAC": {"description": "고객 획득 비용 (Customer Acquisition Cost)", "unit": "currency", "aggregation": "weighted_average", "distribution_type": "lognormal"},
    "MET-Payback_period": {"description": "CAC 회수 기간 (개월)", "unit": "count", "aggregation": "weighted_average", "distribution_type": "lognormal"},
    "MET-ARPU": {"description": "사용자당 평균 매출 (Average Revenue Per User)", "unit": "currency", "aggregation": "weighted_average", "distribution_type": "lognormal"},
    "MET-HHI_revenue": {"description": "허핀달-허쉬만 지수 (매출 기준 시장 집중도)", "unit": "index", "aggregation": "latest", "bounds": {'min': 0, 'max': 10000}, "distribution_type": "beta"},
    "MET-Top3_revenue_share": {"description": "상위 3개 기업 매출 점유율 합계", "unit": "ratio", "aggregation": "latest", "bounds": {'min': 0.0, 'max': 1.0}, "distribution_type": "beta"},
    "MET-Top5_revenue_share": {"description": "상위 5개 기업 매출 점유율 합계", "unit": "ratio", "aggregation": "latest", "bounds": {'min': 0.0, 'max': 1.0}, "distribution_type": "beta"},
    "MET-Platform_commission_fees": {"description": "플랫폼 수수료 수익", "unit": "currency", "aggregation": "sum", "distribution_type": "lognormal"},
    "MET-CapEx": {"description": "자본 지출 (Capital Expenditure)", "unit": "currency", "aggregation": "sum", "distribution_type": "lognormal"},
    "MET-Operating_margin": {"description": "영업이익률", "unit": "ratio", "aggregation": "weighted_average", "bounds": {'min': -1.0, 'max': 1.0}, "distribution_type": "beta"},
    "MET-COGS": {"description": "매출원가 (Cost of Goods Sold)", "unit": "currency", "aggregation": "sum", "distribution_type": "lognormal"},
    "MET-OPEX": {"description": "운영비 (Operating Expenditure)", "unit": "currency", "aggregation": "sum", "distribution_type": "lognormal"},
    "MET-Royalty_expenses": {"description": "로열티 비용", "unit": "currency", "aggregation": "sum", "distribution_type": "lognormal"},
