...
- **대표 강제 지점**: `substrate_plane.stores.project_context_store`, `cognition_plane.engines.world_engine.snapshot(project_context_id)`, `cognition_plane.engines.strategy_engine.search_strategies(project_context_id)`
...
- `project_context_store`: FocalActorContext(PRJ-*) 버전 관리
