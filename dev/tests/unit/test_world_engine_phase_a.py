...
from cmis_core.types import ProjectContext, RealityGraphSnapshot
...
class TestIngestProjectContext:
    """ingest_project_context 테스트"""
    
    def test_ingest_basic(self):
        """기본 ProjectContext → Overlay"""
        ...
        store = ProjectOverlayStore()
        focal_actor_id, updated_ids = ingest_project_context(project_context, store)
...
class TestWorldEnginePhaseA:
    ...
    def test_snapshot_brownfield(self, project_root):
        ...
        focal_actor_id, updated_ids = engine.ingest_project_context(project_context)
