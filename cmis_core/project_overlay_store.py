...
def ingest_project_context(
    ...
    # Overlay 생성
    overlay = overlay_store.create_overlay(project_context_id, focal_actor_id)
    ...
    focal_actor = Node(
        ...
        type="actor",
        data={
            "name": f"Focal Actor ({project_context_id})",
            "kind": "company",
            "traits": {},
    ...
    baseline_state = project_context.baseline_state
    
    if baseline_state:
        baseline_state_id = f"STATE-{project_context_id}-baseline"
    ...
    if brand_assets:
        brand_state_id = f"STATE-{project_context_id}-brand"
        brand_state = Node(
            id=brand_state_id,
            type="state",
            data={
    ...
    if org_assets:
        org_state_id = f"STATE-{project_context_id}-org"
        org_state = Node(
            id=org_state_id,
            type="state",
            data={
