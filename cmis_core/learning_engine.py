...
from .types import Outcome, LearningResult, Strategy, ProjectContext
...
class LearningEngine:
    ...
    def register_project_context(self, project_context: ProjectContext) -> None:
        """ProjectContext 등록 (테스트용)"""
    ...
    def update_project_context_from_outcome_api(
        ...
        """Public API: ProjectContext 업데이트 (cmis.yaml 대응)
